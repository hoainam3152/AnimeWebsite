...
import {
  ...
  NgForm,
  Validators
} from "./chunk-KOIQPKHL.js";
import {
  Location,
  NgClass,
  NgTemplateOutlet,
  isPlatformBrowser
} from "./chunk-YTQ5SJNY.js";
...
var SingleBoxSharedResizeObserver = class {
  ...
  _destroyed = new import_rxjs9.Subject();
  /** Stream of all events from the ResizeObserver. */
  _resizeSubject = new import_rxjs9.Subject();
  ...
  observe(target) {
    if (!this._elementObservables.has(target)) {
      this._elementObservables.set(target, new import_rxjs9.Observable((observer) => {
        ...
        (0, import_operators7.filter)((entries) => entries.some((entry) => entry.target === target)),
        // Share a replay of the last event so that subsequent calls to observe the same element
        // receive initial sizing info like the first one. Also enable ref counting so the
        // element will be automatically unobserved when there are no more subscriptions.
        (0, import_operators7.shareReplay)({
          bufferSize: 1,
          refCount: true
        }),
        (0, import_operators7.takeUntil)(this._destroyed)
      ));
    }
...
var MatFormFieldFloatingLabel = class _MatFormFieldFloatingLabel {
  ...
  _resizeSubscription = new import_rxjs11.Subscription();
  constructor() {
  }
  ngOnDestroy() {
    this._resizeSubscription.unsubscribe();
...
var MatFormField = class _MatFormField {
  ...
  _destroyed = new import_rxjs11.Subject();
  _isFocused = null;
  ...
  _initializeControl(previousControl) {
    ...
    this._describedByChanges?.unsubscribe();
    this._describedByChanges = control.stateChanges.pipe((0, import_operators9.startWith)([void 0, void 0]), (0, import_operators9.map)(() => [control.errorState, control.userAriaDescribedBy]), (0, import_operators9.pairwise)(), (0, import_operators9.filter)(([[prevErrorState, prevDescribedBy], [currentErrorState, currentDescribedBy]]) => {
      return prevErrorState !== currentErrorState || prevDescribedBy !== currentDescribedBy;
    })).subscribe(() => this._syncDescribedByIds());
    this._valueChanges?.unsubscribe();
    if (control.ngControl && control.ngControl.valueChanges) {
      this._valueChanges = control.ngControl.valueChanges.pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
    }
  }
  ...
  _initializePrefixAndSuffix() {
    ...
    (0, import_rxjs11.merge)(this._prefixChildren.changes, this._suffixChildren.changes).subscribe(() => {
      this._checkPrefixAndSuffixTypes();
      this._changeDetectorRef.markForCheck();
    });
  }
...
function isDataSource(value) {
  return value && typeof value.connect === "function" && !(value instanceof import_rxjs12.ConnectableObservable);
}
...
var ArrayDataSource = class extends DataSource {
  ...
  connect() {
    return (0, import_rxjs13.isObservable)(this._data) ? this._data : (0, import_rxjs13.of)(this._data);
  }
  disconnect() {
  }
};
...
var FixedSizeVirtualScrollStrategy = class {
  _scrolledIndexChange = new import_rxjs14.Subject();
  /** @docs-private Implemented as part of VirtualScrollStrategy. */
  scrolledIndexChange = this._scrolledIndexChange.pipe((0, import_operators10.distinctUntilChanged)());
...
var ScrollDispatcher = class _ScrollDispatcher {
  ...
  _scrolled = new import_rxjs14.Subject();
  ...
  scrolled(auditTimeInMs = DEFAULT_SCROLL_TIME) {
    if (!this._platform.isBrowser) {
      return (0, import_rxjs14.of)();
    }
    return new import_rxjs14.Observable((observer) => {
      if (!this._cleanupGlobalListener) {
        this._cleanupGlobalListener = this._ngZone.runOutsideAngular(() => this._renderer.listen("document", "scroll", () => this._scrolled.next()));
      }
      const subscription = auditTimeInMs > 0 ? this._scrolled.pipe((0, import_operators10.auditTime)(auditTimeInMs)).subscribe(observer) : this._scrolled.subscribe(observer);
      this._scrolledCount++;
      return () => {
        subscription.unsubscribe();
        this._scrolledCount--;
  ...
  ancestorScrolled(elementOrElementRef, auditTimeInMs) {
    ...
    return this.scrolled(auditTimeInMs).pipe((0, import_operators10.filter)((target) => !target || ancestors.indexOf(target) > -1));
  }
...
var CdkScrollable = class _CdkScrollable {
  ...
  _destroyed = new import_rxjs14.Subject();
  _renderer = inject(Renderer2);
  _cleanupScroll;
  _elementScrolled = new import_rxjs14.Subject();
  constructor() {
  }
  ngOnInit() {
...
var ViewportRuler = class _ViewportRuler {
  ...
  _change = new import_rxjs14.Subject();
  /** Used to reference correct document/window */
  _document = inject(DOCUMENT);
  constructor() {
    const ngZone = inject(NgZone);
  ...
  change(throttleTime = DEFAULT_RESIZE_TIME) {
    return throttleTime > 0 ? this._change.pipe((0, import_operators10.auditTime)(throttleTime)) : this._change;
  }
  /** Use defaultView of injected document if available or fallback to global window reference */
  _getWindow() {
    return this._document.defaultView || window;
...
var SCROLL_SCHEDULER = typeof requestAnimationFrame !== "undefined" ? import_rxjs14.animationFrameScheduler : import_rxjs14.asapScheduler;
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  _detachedSubject = new import_rxjs14.Subject();
  /** Emits when the rendered range changes. */
  _renderedRangeSubject = new import_rxjs14.Subject();
  ...
  scrolledIndexChange = new import_rxjs14.Observable((observer) => this._scrollStrategy.scrolledIndexChange.subscribe((index) => Promise.resolve().then(() => this.ngZone.run(() => observer.next(index)))));
  ...
  _viewportChanges = import_rxjs14.Subscription.EMPTY;
  _injector = inject(Injector);
  _isDestroyed = false;
  constructor() {
    super();
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => Promise.resolve().then(() => {
      ...
      this.scrollable.elementScrolled().pipe(
        ...
        (0, import_operators10.startWith)(null),
        // Collect multiple events into one until the next animation frame. This way if
        // there are multiple scroll events in the same frame we only need to recheck
        // our layout once.
        (0, import_operators10.auditTime)(0, SCROLL_SCHEDULER),
        // Usually `elementScrolled` is completed when the scrollable is destroyed, but
        // that may not be the case if a `CdkVirtualScrollableElement` is used so we have
        // to unsubscribe here just in case.
        (0, import_operators10.takeUntil)(this._destroyed)
  ...
  attach(forOf) {
    ...
    this.ngZone.runOutsideAngular(() => {
      this._forOf = forOf;
      this._forOf.dataStream.pipe((0, import_operators10.takeUntil)(this._detachedSubject)).subscribe((data) => {
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  viewChange = new import_rxjs14.Subject();
  /** Subject that emits when a new DataSource instance is given. */
  _dataSourceChanges = new import_rxjs14.Subject();
  ...
  set cdkVirtualForOf(value) {
    ...
    if (isDataSource(value)) {
      ...
      this._dataSourceChanges.next(new ArrayDataSource((0, import_rxjs14.isObservable)(value) ? value : Array.from(value || [])));
    }
  }
  _cdkVirtualForOf;
  /**
  ...
  dataStream = this._dataSourceChanges.pipe(
    ...
    (0, import_operators10.pairwise)(),
    // Use `_changeDataSource` to disconnect from the previous data source and connect to the
    // new one, passing back a stream of data changes which we run through `switchMap` to give
    // us a data stream that emits the latest data from whatever the current `DataSource` is.
    (0, import_operators10.switchMap)(([prev, cur]) => this._changeDataSource(prev, cur)),
    // Replay the last emitted data when someone subscribes.
    (0, import_operators10.shareReplay)(1)
  );
  ...
  constructor() {
    ...
    this._viewport.renderedRangeStream.pipe((0, import_operators10.takeUntil)(this._destroyed)).subscribe((range) => {
  ...
  _changeDataSource(oldDs, newDs) {
    ...
    this._needsUpdate = true;
    return newDs ? newDs.connect(this) : (0, import_rxjs14.of)();
  }
...
var CloseScrollStrategy = class {
  ...
  enable() {
    ...
    const stream = this._scrollDispatcher.scrolled(0).pipe((0, import_operators11.filter)((scrollable) => {
...
var OverlayRef = class {
  ...
  _injector;
  _renderer;
  _backdropClick = new import_rxjs15.Subject();
  _attachments = new import_rxjs15.Subject();
  _detachments = new import_rxjs15.Subject();
  _positionStrategy;
  _scrollStrategy;
  _locationChanges = import_rxjs15.Subscription.EMPTY;
  _backdropRef = null;
  ...
  _keydownEvents = new import_rxjs15.Subject();
  /** Stream of mouse outside events dispatched to this overlay. */
  _outsidePointerEvents = new import_rxjs15.Subject();
...
var FlexibleConnectedPositionStrategy = class {
  ...
  _positionChanges = new import_rxjs15.Subject();
  /** Subscription to viewport size changes. */
  _resizeSubscription = import_rxjs15.Subscription.EMPTY;
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  _overlayRef;
  _templatePortal;
  _backdropSubscription = import_rxjs15.Subscription.EMPTY;
  _attachSubscription = import_rxjs15.Subscription.EMPTY;
  _detachSubscription = import_rxjs15.Subscription.EMPTY;
  _positionSubscription = import_rxjs15.Subscription.EMPTY;
  _offsetX;
  _offsetY;
  _position;
  ...
  attachOverlay() {
    ...
    if (this.positionChange.observers.length > 0) {
      this._positionSubscription = this._position.positionChanges.pipe((0, import_operators11.takeWhile)(() => this.positionChange.observers.length > 0)).subscribe((position) => {
...
var SelectionModel = class {
  ...
  changed = new import_rxjs17.Subject();
...
var MatOption = class _MatOption {
  ...
  _stateChanges = new import_rxjs19.Subject();
  constructor() {
...
var MatSelect = class _MatSelect {
  ...
  _animationsDisabled = _animationsDisabled();
  _initialized = new import_rxjs20.Subject();
  _cleanupDetach;
  ...
  _destroy = new import_rxjs20.Subject();
   ...
   * @docs-private
   */
  stateChanges = new import_rxjs20.Subject();
  /**
  ...
  optionSelectionChanges = (0, import_rxjs20.defer)(() => {
    const options = this.options;
    if (options) {
      return options.changes.pipe((0, import_operators13.startWith)(options), (0, import_operators13.switchMap)(() => (0, import_rxjs20.merge)(...options.map((option) => option.onSelectionChange))));
    }
    return this._initialized.pipe((0, import_operators13.switchMap)(() => this.optionSelectionChanges));
  });
  /** Event emitted when the select panel has been toggled. */
  openedChange = new EventEmitter();
  /** Event emitted when the select has been opened. */
  _openedStream = this.openedChange.pipe((0, import_operators13.filter)((o) => o), (0, import_operators13.map)(() => {
  }));
  /** Event emitted when the select has been closed. */
  _closedStream = this.openedChange.pipe((0, import_operators13.filter)((o) => !o), (0, import_operators13.map)(() => {
  }));
  ...
  ngOnInit() {
    ...
    this.stateChanges.next();
    this._viewportRuler.change().pipe((0, import_operators13.takeUntil)(this._destroy)).subscribe(() => {
      if (this.panelOpen) {
  ...
  ngAfterContentInit() {
    ...
    this._selectionModel.changed.pipe((0, import_operators13.takeUntil)(this._destroy)).subscribe((event) => {
      event.added.forEach((option) => option.select());
      event.removed.forEach((option) => option.deselect());
    });
    this.options.changes.pipe((0, import_operators13.startWith)(null), (0, import_operators13.takeUntil)(this._destroy)).subscribe(() => {
      this._resetOptions();
      this._initializeSelection();
    });
  }
  ...
  open() {
    ...
    this._overlayDir.positionChange.pipe((0, import_operators13.take)(1)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
  ...
  _resetOptions() {
    const changedOrDestroyed = (0, import_rxjs20.merge)(this.options.changes, this._destroy);
    this.optionSelectionChanges.pipe((0, import_operators13.takeUntil)(changedOrDestroyed)).subscribe((event) => {
    ...
    (0, import_rxjs20.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators13.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
...
var import_operators14 = __toESM(require_operators(), 1);
...
var MatTooltip = class _MatTooltip {
  ...
  _destroyed = new import_rxjs21.Subject();
  ...
  ngAfterViewInit() {
    ...
    this._setupPointerEnterEventsIfNeeded();
    this._focusMonitor.monitor(this._elementRef).pipe((0, import_operators14.takeUntil)(this._destroyed)).subscribe((origin) => {
      if (!origin) {
  ...
  show(delay = this.showDelay, origin) {
    ...
    instance.afterHidden().pipe((0, import_operators14.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._setTooltipClass(this._tooltipClass);
    this._updateTooltipMessage();
    instance.show(delay);
  }
  ...
  _createOverlay(origin) {
    ...
    strategy.positionChanges.pipe((0, import_operators14.takeUntil)(this._destroyed)).subscribe((change) => {
    ...
    this._updatePosition(this._overlayRef);
    this._overlayRef.detachments().pipe((0, import_operators14.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._overlayRef.outsidePointerEvents().pipe((0, import_operators14.takeUntil)(this._destroyed)).subscribe(() => this._tooltipInstance?._handleBodyInteraction());
    this._overlayRef.keydownEvents().pipe((0, import_operators14.takeUntil)(this._destroyed)).subscribe((event) => {
    ...
    if (!this._dirSubscribed) {
      ...
      this._dir.change.pipe((0, import_operators14.takeUntil)(this._destroyed)).subscribe(() => {
        if (this._overlayRef) {
          this._updatePosition(this._overlayRef);
        }
      });
...
var TooltipComponent = class _TooltipComponent {
  ...
  _onHide = new import_rxjs21.Subject();
...
// node_modules/@angular/material/fesm2022/paginator.mjs
var import_operators15 = __toESM(require_operators(), 1);
...
var MatPaginatorIntl = class _MatPaginatorIntl {
   ...
   */
  changes = new import_rxjs22.Subject();
...
var MatPaginator = class _MatPaginator {
  ...
  _intlChanges;
  _isInitialized = false;
  _initializedStream = new import_rxjs22.ReplaySubject(1);
  /**
